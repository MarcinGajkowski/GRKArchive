...
void Plane::Initialize(int m, int n){
    ...
    model_matrix_.Translate(0, 0, -8);

    TextureVertex vertices[4]={

        {{-(float)(m),0.0f,-(float)(n),1.0f},{(float)(0),(float)(1)}}, // spróbowaæ -m, n, 0101
        {{(float)(m),1.0f,-(float)(n),1.0f},{(float)(1),(float)(1)}}, // m, n, 0111
        {{(float)(m),1.0f,(float)(n),0.0f},{(float)(1),(float)(0)}}, // -m, -n, 0100
        {{-(float)(m),0.0f,(float)(n),0.0f},{(float)(0),(float)(0)}} //m -n, 0110
